...
$secret_key = 'u6iduw8MKjvu3SaNrLuc'; // Защищённый ключ приложения
    ...
    case 'get_item':
      ...
      if ($item == 'item1') {
        $response['response'] = array(
          ...
          'photo_url' => 'https://github.com/punisherpete/VKSDK-Test/blob/main/pinpng.com-gold-coins-png-39977.png',
          'price' => 5
        );
      } elseif ($item == 'item2') {
        $response['response'] = array(
